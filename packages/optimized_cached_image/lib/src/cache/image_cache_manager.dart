...
const List<String> supportedFileNames = <String> ['jpg', 'jpeg', 'png', 'tga', 'gif', 'cur', 'ico'];
mixin OicImageCacheManager on BaseCacheManager {
  ...
  final Map<String, Stream<FileResponse>> _runningResizes = <String, Stream<FileResponse>> {};
