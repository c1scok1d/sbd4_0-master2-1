...
class _ZoomableWidgetState extends State<ZoomableWidget> {
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    const Size _marginSize = Size(100.0, 100.0);
    ...
    if ((widget.singleFingerPan && details.scale == 1.0) ||
      ...
      final Offset _panRealOffset = (details.focalPoint -
              _zoomOriginOffset +
      ...
      if (widget.panLimit == 0.0) {
        ...
        final Offset _baseOffset = Offset(
          _panRealOffset.dx
        ...
        final double _widthFactor = sqrt(_marginOffset.dx.abs()) / _marginSize.width;
  ...
  void _handleDoubleTap() {
    ...
    if (_tmpZoom > widget.maxScale || _stepLength == 0.0) {
      _tmpZoom = 1.0;
    }
